 ...
 */
  ...
  render() {
    const paddingAlign = I18nManager.isRTL ? 'paddingRight' : 'paddingLeft';
    const iconAlign = I18nManager.isRTL ? 'right' : 'left';
    return (
      <Animated.View
        ref="searchContainer"
        style={[
      ...
      >
        ...
        <TouchableWithoutFeedback onPress={this.onFocus}>
          {this.props.iconSearch
            ? <Animated.View
                style={[styles.iconSearch, { [`${iconAlign}`]: this.iconSearchAnimated }]}
              >
                {this.props.iconSearch}
              </Animated.View>
            : <Animated.Image
                ...
                style={[
                  ...
                  {
                    [`${iconAlign}`]: this.iconSearchAnimated
                  }
                ]}
              />}
        </TouchableWithoutFeedback>
